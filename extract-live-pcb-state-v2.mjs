...
const componentIds=captured.reads.components.items.map(item=>item.primitiveId);
captured.reads.pins=(await readPcb({target,kind:'pins',ids:componentIds,offset:0,limit:2000})).result;
